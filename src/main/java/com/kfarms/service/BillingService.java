...
public interface BillingService {
    ...
    Map<String, Object> createCheckoutSession(String planId, String successUrl, String cancelUrl, String customerEmail, String actor);
    Map<String, Object> verifyCheckoutSession(String reference, String planId, String actor);
