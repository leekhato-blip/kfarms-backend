...
public interface FishPondService {
    ...
    Map<String, Object> getAll(int page, int size, String pondName, String pondType, String status, LocalDate lastWaterChange, Boolean deleted);
    ...
    FishPondResponseDto recordMortality(Long id, MortalityRecordRequestDto request, String updatedBy);
}
