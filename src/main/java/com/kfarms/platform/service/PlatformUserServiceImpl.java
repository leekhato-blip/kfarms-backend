...
public class PlatformUserServiceImpl implements PlatformUserService {
    ...
    public Page<PlatformUserListItemDto> searchUsers(
        ...
        Page<AppUser> users = normalizedSearch == null
                ? appUserRepo.findByRole(Role.PLATFORM_ADMIN, pageable)
                : appUserRepo.searchByRole(Role.PLATFORM_ADMIN, normalizedSearch, pageable);
    ...
    private java.util.Optional<PlatformUserInvitation> findReusableInvitation(String username, String email) {
        java.util.Optional<PlatformUserInvitation> pendingByEmail = invitationRepo.findByEmailIgnoreCaseAndAcceptedFalse(email);
        java.util.Optional<PlatformUserInvitation> pendingByUsername = invitationRepo.findByUsernameIgnoreCaseAndAcceptedFalse(username);
